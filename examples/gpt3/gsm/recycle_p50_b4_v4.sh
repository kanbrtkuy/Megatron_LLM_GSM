...
CUSTOM_REPEAT_PATTERN="[1,2,3,4,4,3,2,1]"
...
CHECKPOINT_PATH='./results/gsm_recycle_p50_b4_v4/ckpts/'   #$1 #<Specify path>  
TENSORBOARD_LOGS_PATH='./results/gsm_recycle_p50_b4_v4/tensorboard/' #$2 #<Specify path>
...
torchrun ${DISTRIBUTED_ARGS[@]} pretrain_gpt.py \
    ...
    ${MODEL_PARALLEL_ARGS[@]} \
    ${DATA_ARGS[@]} \
    ${EVAL_AND_LOGGING_ARGS[@]} > ./results/gsm_recycle_p50_b4_v4.log
