...
CHECKPOINT_PATH='./results/random_base_p50_b4_v0/ckpts/'   #$1 #<Specify path>  
TENSORBOARD_LOGS_PATH='./results/random_base_p50_b4_v0/tensorboard/' #$2 #<Specify path>
...
torchrun ${DISTRIBUTED_ARGS[@]} pretrain_gpt.py \
    ...
    ${MODEL_PARALLEL_ARGS[@]} \
    ${DATA_ARGS[@]} \
    ${EVAL_AND_LOGGING_ARGS[@]}  > ./results/random_base_p50_b4_v0.log
