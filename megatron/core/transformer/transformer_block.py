...
class TransformerBlock(MegatronModule):
    ...
    def __init__(
        ...
        repeat_pattern: Optional[List[int]] = None, #revise
    ):
        ...
        self.repeat_pattern = repeat_pattern  #revise
        ...
        with rng_context, fp8_context:
            ...
            if self.config.recompute_granularity == 'full' and self.training:
                ...
                if self.repeat_pattern:
                    # print("have repeat! the repeat mode is ",self.repeat_pattern)
                    for l_no, idx in enumerate(self.repeat_pattern):
                    ...
                    # print("don't have repeat! base model!")
